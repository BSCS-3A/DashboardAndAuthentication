    ...
    <nav id="nav-container">
        ...
        <ul>
            ...
            <li>
                ...
                <a class="Auser" href="#"><img class="Auser-profile" src="assets/img/user.png"></a>
    ...
    <section id="section-container">
        <article>
            <div class="Alogo-container">
        		<img class="Alogos" src="assets/img/BU-LOGO.png">
        		<img class="Alogos" src="assets/img/BUHS LOGO.png">
        		<img class="Alogos" src="assets/img/SSG LOGO.png">
        	</div>
